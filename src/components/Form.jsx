            ...
            <form className="bg-[url('/assets/pic2.png')] grid grid-cols-2 w-fit mx-auto gap-5 p-4" data-netlify="true" name="contact">
                ...
                <div className="gap-5 flex justify-center col-span-2">
                    <div className="w-1/2 space-y-2">
                        ...
                        <input className="pb-3 pt-3 pl-5 text-zinc-300 block w-full rounded focus:outline-none focus:shadow-md focus:border-10 shadow-slate-900 bg-[#201f1f] placeholder-gray-800" type="text" name="firstname" placeholder="Johnny Depp" />
                    </div>
                    <div className="w-1/2 space-y-2">
