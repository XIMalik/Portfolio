...
export default function Section(props){
    return(
        <div className="flex-wrap lg:flex items-center justify-center">
            <div className="w-4/4 lg:w-1/4 bg-[url('./src/assets/start.jpg')] bg-cover h-full rounded-lg">
            ...
            <div className="flex flex-wrap flex-col justify-center items-center md:flex-row gap-10 w-4/4 lg:w-3/4 rounded-full md:rounded-lg p-5 bg-green-300">
                <div className="">
